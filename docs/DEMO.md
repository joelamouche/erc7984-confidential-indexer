...
export NONDELEGATED=0x190f81dDA6433411a5e6a32aFB29dDc4D9fB49a3 # the fresh non-delegated subject — from demo:reset
...
```
[acl]   DELEGATION observed: 0x190f81 → holder; promoting their pending rows for backfill
```
